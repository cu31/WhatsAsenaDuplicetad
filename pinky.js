...
module.exports = {
 OB_NAME: process.env.Z_BOT_NAME === undefined ? 'Darks' : process.env.Z_BOT_NAME,
 OA_NAME: process.env.Z_DEP_NAME === undefined ? 'drk' : process.env.Z_DEP_NAME,
 ...
 PHONE: process.env.NUMBER === undefined ? '+905510310485' : process.env.NUMBER,   
